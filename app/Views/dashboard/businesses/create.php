            ...
            <div class="col-xl-10 col-lg-12">
                <div class="card">
                    <div class="card-header border-0">
                        <div>
                            <h4 class="card-title mb-1">İşletme ekle</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('dashboard/businesses/store') ?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="category">Kategori / Sektör</label>
                                ...
                                <div class="col-md-6 mb-3" id="custom-category-wrapper" style="display: <?= old('category') === 'Diger' ? 'block' : 'none' ?>;">
                                    <label class="form-label" for="custom_category">Diğer kategori</label>
                                ...
                                <div class="col-12 mb-4">
                                    <label class="form-label" for="short_description">Kısa açıklama</label>
                            ...
                            <div class="d-flex gap-2 flex-wrap">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> İşletmeyi kaydet</button>
                                <a href="<?= base_url('dashboard/businesses') ?>" class="btn btn-light border">Vazgeç</a>
                            </div>
                        </form>
                    </div>
                </div>
