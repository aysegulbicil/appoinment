...
<form action="<?= base_url('dashboard/businesses/' . $business['id'] . '/update') ?>" method="post">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <label class="form-label" for="general-name">İşletme adı</label>
        ...
        <div class="col-md-6 mb-3" id="general-custom-category-wrapper" style="display: <?= $isCustomCategory ? 'block' : 'none' ?>;">
            <label class="form-label" for="general-custom-category">Diğer kategori</label>
        ...
        <div class="col-md-6 mb-3">
            <label class="form-label" for="general-city">Şehir</label>
        ...
        <div class="col-md-6 mb-3">
            <label class="form-label" for="general-district">İlçe</label>
        ...
        <div class="col-md-8 mb-3">
            <label class="form-label" for="general-short-description">Kısa açıklama</label>
    ...
    <button type="submit" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Değişiklikleri kaydet</button>
</form>
<script>
