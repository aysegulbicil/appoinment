...
<div class="deznav">
    <div class="deznav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <?php endforeach; ?>
            <li class="nav-label">Web Ayarları</li>
            <?php
            $webMenuItems = [
                ['label' => 'Sayfalar', 'path' => 'dashboard/web', 'active' => str_starts_with($currentPath, 'dashboard/web')],
                ['label' => 'Sayfa Ekle', 'path' => 'dashboard/web?section=create', 'active' => str_starts_with($currentPath, 'dashboard/web')],
                ['label' => 'Genel Ayarlar', 'path' => 'dashboard/web?section=general', 'active' => str_starts_with($currentPath, 'dashboard/web')],
                ['label' => 'Menü Ayarları', 'path' => 'dashboard/web?section=menu', 'active' => str_starts_with($currentPath, 'dashboard/web')],
                ['label' => 'SEO Ayarları', 'path' => 'dashboard/web?section=seo', 'active' => str_starts_with($currentPath, 'dashboard/web')],
            ];
            ?>
            <?php foreach ($webMenuItems as $item): ?>
                <li class="<?= $item['active'] ? 'mm-active' : '' ?>">
                    <a href="<?= base_url($item['path']) ?>" class="<?= $item['active'] ? 'mm-active' : '' ?>" aria-expanded="false">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe"><circle cx="12" cy="12" r="10"></circle><path d="M2 12h20"></path><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
                        <span class="nav-text"><?= esc($item['label']) ?></span>
                    </a>
                </li>
            <?php endforeach; ?>
